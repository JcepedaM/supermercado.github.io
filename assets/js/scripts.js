...
function addSale() {
	...
	var saleDetailsDescription = $('#saleDetailsDescription').val();
	var saleDetailsDescription = $('#saleDetailsDescription').val();
	 // Agrega esta línea para obtener el valor de la descripción
	...
	$.ajax({
		...
		data: {
			...
			saleDetailsDescription: saleDetailsDescription,
