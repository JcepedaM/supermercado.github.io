	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">AGREGAR ARTICULO</a>
			  <a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false">COMPRA A PROVEEDOR</a>
			  <a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">AGREGAR PROVEEDOR</a>
			  ...
			  <a class="nav-link" id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false">INSERTAR CLIENTE</a>
			...
			<div class="tab-content" id="v-pills-tabContent">
			  <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Detalle del articulo</div>
				  <div class="card-body">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemDetailsTab">Articulo</a>
						</li>
						<li class="nav-item">
					...
					<div class="tab-content">
							...
							<form>
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemDetailsItemNumber">ID del articulo<span class="requiredIcon">*</span></label>
							  ...
							  <div class="form-row">
								  <div class="form-group col-md-6">
									<label for="itemDetailsItemName">Nombre del articulo<span class="requiredIcon">*</span></label>
							  ...
							  <div class="form-row">
								...
								<div class="form-group col-md-3">
								  <label for="itemDetailsUnitPrice">Precio por unidad<span class="requiredIcon">*</span></label>
							  ...
							  <button type="button" id="addItem" class="btn btn-success">Agregar Articulo</button>
							  <button type="button" id="updateItemDetailsButton" class="btn btn-primary">Actualizar</button>
							  <button type="button" id="deleteItem" class="btn btn-danger">Borrar Item</button>
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<form name="imageForm" id="imageForm" method="post">
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemImageItemNumber">Numero de articulo<span class="requiredIcon">*</span></label>
								...
								<div class="form-group col-md-4">
									<label for="itemImageItemName">Nombre de articulo</label>
							  ...
							  <br>
							  <button type="button" id="updateImageButton" class="btn btn-primary">Subir imagen</button>
							  <button type="button" id="deleteImageButton" class="btn btn-danger">Borrar Imagen</button>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="purchaseDetailsItemNumber">Numero de articulo<span class="requiredIcon">*</span></label>
					  ...
					  <div class="form-row"> 
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsItemName">Nombre del árticulo<span class="requiredIcon">*</span></label>
						  ...
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsVendorName">Nombre del proveedor<span class="requiredIcon">*</span></label>
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						  <label for="purchaseDetailsUnitPrice">Precio por unidad<span class="requiredIcon">*</span></label>
						  <input type="text" class="form-control" id="purchaseDetailsUnitPrice" name="purchaseDetailsUnitPrice" value="0">
						  
						</div>
						<div class="form-group col-md-2">
						  <label for="purchaseDetailsTotal">Total Costo</label>
						  <input type="text" class="form-control" id="purchaseDetailsTotal" name="purchaseDetailsTotal" readonly>
						</div>
					  </div>
					  <button type="button" id="addPurchase" class="btn btn-success">Agregar compra</button>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorMobile">Número de telefono<span class="requiredIcon">*</span></label>
						  ...
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorPhone2">Telefono 2</label>
					  ...
					  <div class="form-group">
						<label for="vendorDetailsVendorAddress">Direccion<span class="requiredIcon">*</span></label>
						<input type="text" class="form-control" id="vendorDetailsVendorAddress" name="vendorDetailsVendorAddress">
					  </div>
					  <div class="form-group">
						<label for="vendorDetailsVendorAddress2">Direccion 2</label>
					  ...
					  <button type="button" id="addVendor" name="addVendor" class="btn btn-success">Agregar proveedor</button>
					  <button type="button" id="updateVendorDetailsButton" class="btn btn-primary">Actualizar</button>
					  <button type="button" id="deleteVendorButton" class="btn btn-danger">Borrar</button>
					  <button type="reset" class="btn">Limpiar</button>
					 </form>
				  </div> 
				</div>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="saleDetailsItemNumber">ID de articulo<span class="requiredIcon">*</span></label>
						...
						<div class="form-group col-md-4">
						  <label for="saleDetailsCustomerName">Nombre del cliente</label>
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-5">
							<label for="saleDetailsItemName">Nombre del articulo</label>
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate" value="2023-09-21" name="saleDetailsSaleDate" readonly>
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
						...
						<div class="form-row">
								<div class="form-group col-md-6" style="display:inline-block">
								  <!-- <label for="saleDetailsDescription">Description</label> -->
								  <textarea rows="4" class="form-control" placeholder="Description" name="saleDetailsDescription" id="saleDetailsDescription"></textarea>
								</div>
						...
						<div class="form-group col-md-2">
						  <label for="saleDetailsUnitPrice">Precio por unidad<span class="requiredIcon">*</span></label>
					  ...
					  <button type="button" id="addSaleButton" class="btn btn-success">Agregar venta</button>
					 ...
					 <form> 
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						 ...
						 <div class="form-group col-md-3">
							<label for="customerDetailsCustomerID">ID del cliente</label>
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerMobile">Numero de telefono<span class="requiredIcon">*</span></label>
						  ...
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerPhone2">telefono 2</label>
					  ...
					  <div class="form-group">
						<label for="customerDetailsCustomerAddress">Direccion<span class="requiredIcon">*</span></label>
						<input type="text" class="form-control" id="customerDetailsCustomerAddress" name="customerDetailsCustomerAddress">
					  </div>
					  <div class="form-group">
						<label for="customerDetailsCustomerAddress2">Direccion 2</label>
					  ...
					  <button type="button" id="addCustomer" name="addCustomer" class="btn btn-success">Agregar Cliente</button>
					  <button type="button" id="updateCustomerDetailsButton" class="btn btn-primary">Actualizar</button>
					  <button type="button" id="deleteCustomerButton" class="btn btn-danger">Borrar</button>
					  <button type="reset" class="btn">Limpiar</button>
					 </form>
				  </div> 
				</div>
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Busqueda de inventario<button id="searchTablesRefresh" name="searchTablesRefresh" class="btn btn-warning float-right btn-sm">Actualizar</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemSearchTab">Inventario</a>
						</li>
						<li class="nav-item">
					...
					<div class="tab-content">
						<div id="itemSearchTab" class="container-fluid tab-pane active">
						  <br>
						  <p>Utilice la siguiente cuadrícula para buscar todos los detalles de los artículos.</p>
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemReportsTab">Articulos</a>
						</li>
						<li class="nav-item">
					...
					<div class="tab-content">
						<div id="itemReportsTab" class="container-fluid tab-pane active">
							<br>
							<p>Utilice la siguiente cuadrícula para obtener informes de artículos</p>
						...
						<div id="saleReportsTab" class="container-fluid tab-pane fade">
							...
							<form> 
							  ...
							  <button type="reset" id="saleFilterClear" class="btn">Borrar</button>
							</form>
							<br><br>
						...
						<div id="purchaseReportsTab" class="container-fluid tab-pane fade">
							...
							<form> 
							  ...
							  <button type="reset" id="purchaseFilterClear" class="btn">Borrar</button>
							</form>
							<br><br>
						...
						<div id="vendorReportsTab" class="container-fluid tab-pane fade">
							<br>
							<p>Utilice la siguiente cuadrícula para obtener informes para proveedores</p>
