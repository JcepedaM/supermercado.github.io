				...
				<div class="card">
				  ...
				  <div class="card-body">
					...
					<div id="registerMessage"></div>
					  ...
					  <div class="form-group">
						<label for="registerPassword2">Vuelve a ingresar la contraseña<span class="requiredIcon">*</span></label>
					  ...
					  <button type="button" id="register" class="btn btn-success">Registrarse</button>
					  <a href="login.php?action=resetPassword" class="btn btn-warning">Resetear la contraseña</a>
				...
				<div class="card">
				  ...
				  <div class="card-body">
					...
					<div id="resetPasswordMessage"></div>
					  ...
					  <a href="login.php" class="btn btn-primary">Ingresar</a>
					  <a href="login.php?action=register" class="btn btn-success">Registrarse</a>
					  <button type="button" id="resetPasswordButton" class="btn btn-warning">Resetear contraseña</button>
					  <button type="reset" class="btn">Limpiar</button>
					</form>
				  </div>
				</div>
...
?>
    ...
    <div class="container">
	  ...
	  <div class="col-sm-12 col-md-5 col-lg-5">
		<div class="card">
		  <div class="card-header">
			Ingresar al sistema Supermercado
		  </div>
		  <div class="card-body">
			<form action="">
